$(function () {
    ...
    $.ajax({
        ...
        success:function(res){
            // res 为接口返回的数据
             ceshi1(res.ydata,res.color,res.xdata)
             ceshi2(res.ceshi2)
             ceshi3(res.ceshi3)
             ceshi4(res.ceshi4)
             ceshi5(res.ceshi5)
    ...
    function ceshi1(ydata,color,xdata) {
            ...
            series: [
                {
                    ...
                    // data: [120, 4.9, 7.0, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 6.4, 3.3]
                    data:res.zhuceliang
                },
                {
                    name: '活跃量',
                    ...
                    // data: [110.0, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3]
                    data:res.huoyueliang
                },
                {
                    name: '同比增加',
                    type: 'line',
...
////////////////////////////////////////
    ...
    function ceshi6(data) {
        var myChart = echarts.init($("#ceshi6")[0]);

        // var data = [10, 20, 30, 5, 15, 2, 8, 10];
        var sum = 0;
        var percentdata = [];
        for (var i = 0; i < data.length; i++) {
            sum += data[i];
        ...
        /*    var giftImageUrl = "data:image/png;base64,";
            */option = {
            ...
            legend: {
                ...
                bottom: -20,
                x: 'center',
                data: ['小于20岁', '20~24岁', '25~29岁', '30~34岁', '35~39岁', '40~49岁', '大于50岁'],
                textStyle: {
                    color: '#fff'
                }
            },
